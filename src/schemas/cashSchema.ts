...
export const open = z.strictObject({
  initialAmount: z
    .number("O valor inicial deve ser um número")
    .nonnegative("O valor inicial não pode ser negativo")
    .multipleOf(0.01, "O valor inicial deve ter no máximo duas casas decimais"),
});

export const close = z.strictObject({
  closingAmount: z
    .number("O valor final deve ser um número")
    .nonnegative("O valor final não pode ser negativo")
    .multipleOf(0.01, "O valor final deve ter no máximo duas casas decimais"),
});
